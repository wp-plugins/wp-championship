...
if ( !class_exists('cs_widget') )
{
	...
	function form( $instance )
	{
      ...
      ?>
      <p>
        <label for="<?php echo $this->get_field_id('title');?>"><?php echo __("Title","wpcs");?>: </label>
        <input id="<?php echo $this->get_field_id('title');?>" name="<?php echo $this->get_field_name('title');?>" type="text" value="<?php echo $title;?>"/></p>
      <p>
	<label for="widget_wp_championship_points-showAverage"><?php echo __("Durchschnitt anzeigen?","wpcs");?> </label>
        <input type="radio" name="<?php echo $this->get_field_name('showAverage');?>" id="<?php echo $this->get_field_name('showAverage');?>" value="1" <?php if($showAverage == '1') echo 'checked="checked"';?>><?php echo __("Ja","wpcs");?>
																	       <input type="radio" name="<?php echo $this->get_field_name('showAverage');?>" id="<?php echo $this->get_field_name('showAverage');?>" value="0" <?php if($showAverage == '0') echo 'checked="checked"';?>><?php echo __("Nein","wpcs");?>
      </p>
      <p>
	<label for="widget_wp_championship_points-showAmountTipps"><?php echo __("Anzahl der Tipps?","wpcs");?></label>
        <input type="radio" name="<?php echo $this->get_field_name('showAmountTipps');?>" id="<?php echo $this->get_field_name('showAmountTipps');?>" value="1" <?php if($showAmountTipps == '1') echo 'checked="checked"';?>><?php echo __("Ja","wpcs");?>
																	       <input type="radio" name="<?php echo $this->get_field_name('showAmountTipps');?>" id="<?php echo $this->get_field_name('showAmountTipps');?>" value="0" <?php if($showAmountTipps == '0') echo 'checked="checked"';?>><?php echo __("Nein","wpcs");?>
      </p>
      <p>
	 <label for="widget_wp_championship_points-showUserTendence"><?php echo __("Tendenz anzeigen?","wpcs");?></label>
       <input type="radio" name="<?php echo $this->get_field_name('showUserTendence');?>" id="<?php echo $this->get_field_name('showUserTendence');?>" value="1" <?php if($showUserTendence == '1') echo 'checked="checked"';?>><?php echo __("Ja","wpcs");?>
       <input type="radio" name="<?php echo $this->get_field_name('showUserTendence');?>" id="<?php echo $this->get_field_name('showUserTendence');?>" value="0" <?php if($showUserTendence == '0') echo 'checked="checked"';?>><?php echo __("Nein","wpcs");?>
      </p>            
      <p>
	<label for="widget_wp_championship_points-AmountUsers"><?php echo __("Anzahl der angezeigten Mitspieler","wpcs");?></label>
        <input style="width: 30px;" maxlength="2" type="text" name="<?php echo $this->get_field_name('AmountUsers');?>" id="<?php echo $this->get_field_name('AmountUsers');?>" value="<?php echo $AmountUsers;?>" />
      </p>
      <p>
        <label for="widget_wp_championship_points-showFullRanking"><?php echo __("Link anzeigen?","wpcs");?> </label>
        <input type="radio" name="<?php echo $this->get_field_name('showFullRanking');?>" id="<?php echo $this->get_field_name('showFullRanking');?>" value="1" <?php if($showFullRanking == '1') echo 'checked="checked"';?>><?php echo __("Ja","wpcs");?>
	<input type="radio" name="<?php echo $this->get_field_name('showFullRanking');?>" id="<?php echo $this->get_field_name('showFullRanking');?>" value="0" <?php if($showFullRanking == '0') echo 'checked="checked"';?>><?php echo __("Nein","wpcs");?>
      </p> 
      <p>
	    <label for="widget_wp_championship_points-FullRankingURL"><?php echo __("Link URL","wpcs");?> http://</label>
        <input type="text" id="<?php echo $this->get_field_name('FullRankingURL');?>" name="<?php echo $this->get_field_name('FullRankingURL');?>" value="<?php echo $FullRankingURL;?>" />
      </p>
      <p>
	<label for="widget_wp_championship_points-FullRankingURLTitle"><?php echo __("Link Bezeichnung","wpcs"); ?> </label>
        <input type="text" id="<?php echo $this->get_field_name('FullRankingURLTitle');?>" name="<?php echo $this->get_field_name('FullRankingURLTitle');?>" value="<?php echo $FullRankingURLTitle;?>" />
      </p>             
      <?php
