...
function cs_admin_users()
{
	...
	$out .= '<tr><th scope="row" valign="top"><label for="mailreceipt">'.__('Mailbestätigung','wpcs').':</label></th>'."\n";
	$out .= '<td><input name="mailreceipt" id="mailreceipt" type="checkbox" value="1" '. ($results->mailreceipt==1?'checked="checked"':'') . '  /></td></tr>'."\n";
	...
	$out .= '<tr><th scope="row" valign="top"><label for="tippgroup">'.__('Tippgruppe','wpcs').':</label></th>'."\n";
	$out .= '<td><input name="tippgroup" id="tippgroup" type="text" value="'. $results->tippgroup.'"  /></td></tr>'."\n";
	...
	$out .= '<th scope="col" width="70" style="text-align: center">'.__('Mailbestätigung',"wpcs").'</th>'."\n";
	...
	$out .= '<th scope="col" width="90" style="text-align: center">'.__('Tippgruppe',"wpcs").'</th>'."\n";
	...
	foreach($results as $res) {
		...
		$out .= "<td align=\"center\">".$res->mailservice."</td><td align=\"center\">".$res->mailreceipt."</td>";
		$out .= "<td align=\"center\">".$res->stellvertreter."</td>";
		$out .= "<td align=\"center\">".($res->champion ==-1 ? "-" : $res->name )."</td>";
		$out .= "<td align=\"center\">".$res->tippgroup."</td>";
